...
SELECT ProductName as Name from Products_
...
INSERT INTO Customers_ (CustomerID, FirstName, LastName, Email, Phone, Address, City, State, PostalCode, Country) VALUES
...
SELECT * FROM CUSTOMERS_  AS CLIENT
...
select ProductName from Products_
UNION
...
SELECT IIF(Price >1000, 'Expensive', 'Affordable' ) from Products_ 
...
--15Write a query that uses a CASE statement to determine the discount percentage based on the quantity purchased. Use orders table. Result set should show customerid, quantity and discount percentage. The discount should be applied as follows: 1 item: 3% Between 1 and 3 items : 5% Otherwise: 7%
