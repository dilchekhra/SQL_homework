...
--11.Using Employees, Departments table List employee names and department names where department IDs are 
--not equal. It means: Show all mismatched employee-department combinations.
select e.Name, d.DepartmentName
from employees as e
...
--24.Using Employees table List employees who are managers of someone, but their salary is less
--than or equal to the person they manage.
